...
CREATE TABLE `endereco` (
  ...
  `end_tipo` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`end_id`)
...
INSERT INTO pedido_venda (vend_id_cliente, ven_end_id, ven_cupom_promocional_id, ven_status, ven_data, ven_valor) VALUES 
(20, 42, 1, 'Em andamento', '2024-04-12', 100.00),
(20, 42, 2, 'Entregue', '2024-04-10', 150.00),
(20, 43, NULL, 'Em processamento', '2024-04-11', 200.00);
