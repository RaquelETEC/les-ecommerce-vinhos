	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="container mt-4">
					...
					<form class="mb-4">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<label for="preco" class="form-label">Pre�o em R$</label> <input
							...
							<div class="col-md-3">
								<label for="regiao" class="form-label">Regi�o:</label> <input
							...
							<div class="col-md-3">
								<label for="alcool" class="form-label">Teor alco�lico em
							...
							<div class="col-md-3">
								<label for="grupoPrecificacao" class="form-label">Grupo
									de Precifica��o:</label> <select class="form-select"
									...
									<option value="Grupo Premium"
										...
										Premium</option>
									<option value="Grupo Intermedi�rio"
										<%="Grupo Intermedi�rio".equals(request.getAttribute("PrecificacaoDesc")) ? "selected" : ""%>>Grupo
										Intermedi�rio</option>
									<option value="Grupo Econ�mico"
										<%="Grupo Econ�mico".equals(request.getAttribute("PrecificacaoDesc")) ? "selected" : ""%>>Grupo
										Econ�mico</option>
									<option value="Grupo de Promo��o"
										<%="Grupo de Promo��o".equals(request.getAttribute("PrecificacaoDesc")) ? "selected" : ""%>>Grupo
										de Promo��o</option>
				...
				<!-- Adicionar harmonizações -->
				<div class="row justify-content-left mt-5"
					style="margin-left: 125px;">
					<div class="col-md-8">
						<h3 class=" mb-3">Adicionar Harmoniza��o</h3>
						<table class="table">
							<thead>
								<tr>
									<th>Harmoniza��o</th>
							...
							<tbody id="tabelaHarmonizacoes">
								<!-- Linhas da tabela de harmonizações serão adicionadas aqui -->
							</tbody>
						</table>
