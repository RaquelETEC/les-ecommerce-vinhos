...
function calcularTotais(valorCupomPerc = 0, valorCupomT = 0, valorCartoes = 0) {
    ...
    let totalCupomPValor = totalCupomPromocional > 0 ?  (totalCupomPromocional * 100) / TotalProduto : 0;
...
function validarPedido() {
	...
	}else if(totalPagamento + totalCupons  != totalPedido ){
		alert('O valor do pagamento e cupons diverge do total do pedido');
	}
    else {
