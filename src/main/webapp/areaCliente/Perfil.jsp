			...
			<div class="container-register">
				...
				<div class="content">
					...
					<form class="form-register"
						action="/les-ecommerce-vinhos/updateCliente"
						onsubmit="return validarAtualizar()">
						...
						<div class="box-input-form" style="display: none;">
							...
							<input type="text" name="typeId" id="typeId"
								class="input-form input-width-1" value="<%=cliente.getId()%>">
						...
						<div class="box-input-form">
							...
							<input type="text" name="typeNome" id="typeNome"
								class="input-form input-width-1" value="<%=cliente.getNome()%>">
						...
						<div class="box-input-form">
							...
							<input type="number" name="typeCPF" id="typeCPF"
								class="input-form input-width-2 "
						...
						<div class="box-input-form">
							...
							<input type="date" name="typeNascimento" id="typeNascimento"
								class="input-form input-width-3 "
						...
						<div class="box-input-form">
							...
							<input type="tel" name="typeNumeroTelefone"
								id="typeNumeroTelefone" class="input-form input-width-2 "
							...
							<select id="tipoTelefone" name="tipoTelefone"
								class="input-form input-width-2">
								<option value="Fixo"
									<%="Fixo".equals(cliente.getTipoTelefone()) ? "selected" : ""%>>Fixo</option>
								<option value="Celular"
									<%="Celular".equals(cliente.getTipoTelefone()) ? "selected" : ""%>>Celular</option>
							</select>
						</div>
						...
						<div class="box-input-form">
							...
							<input type="radio" name="genero" id="Feminino"
								class="input-radio" value="Feminino"
								<%="Feminino".equals(cliente.getGenero()) ? "checked" : ""%>>
							<label for="Feminino" style="font-weight: 100">Feminino</label>

							<input type="radio" name="genero" id="Masculino"
								class="input-radio" value="Masculino"
								<%="Masculino".equals(cliente.getGenero()) ? "checked" : ""%>>
							<label for="Masculino" style="font-weight: 100;">Masculino</label>

							<input type="radio" name="genero" id="nao_binario"
								class="input-radio" value="Não Binário"
								<%="Não Binário".equals(cliente.getGenero()) ? "checked" : ""%>>
							<label for="nao_binario" style="font-weight: 100;">Não
								Binario</label> <input type="radio" name="genero" id="Outros"
								class="input-radio" value="Outros"
								<%="Outros".equals(cliente.getGenero()) ? "checked" : ""%>>
						...
						<div class="box-input-form">
							...
							<select id="statusCliente" name="statusCliente"
								class="input-form input-width-1">
								<option value="Ativo"
									<%="Ativo".equals(cliente.getStatus()) ? "selected" : ""%>>Ativo</option>
								<option value="Inativo"
									<%="Inativo".equals(cliente.getStatus()) ? "selected" : ""%>>Inativo</option>
							</select>
						</div>
