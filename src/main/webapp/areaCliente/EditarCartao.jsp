			...
			<div class="col-12 col-md-8 col-lg-6 col-xl-8">
				<div class="card shadow-2-strong">
					<div class="card-body p-5 ">
						<h3 class="mb-4 c text-center">Editar Cart�o</h3>
								...
								<div class="row">
									<div class="col-md-6 mb-4">
										<label class="form-label" for="CartaoNome">Nome
											impresso do cart�o</label> <input type="text" name="CartaoNome"
								...
								<div class="row">
									...
									<div class="col-md-6 mb-4">
										<label class="form-label" for="CartaoCodigo">Codigo de
											Seguran�a</label> <input type="text" name="CartaoCodigo"
											id="CartaoCodigo" class="form-control form-control-lg"
											required value=<%=cartao.getCodigoSeguranca()%> />
									</div>

									<div class="col-md-6 mb-4">
										<label class="form-label" for="CartaoPadrao">Padr�o</label> <select
											...
											<option value="NAO"
												<%=cartao.getPadrao().equals("NAO") ? "selected" : ""%>>N�O</option>
										</select>
									</div>
								</div>
