        ...
        <div class="container-main">
                ...
                <div class="box-dados-perfil">
                    ...
                    <div class="box-exibir-opcoes">
						<button
							...
							Perfil</button>
						<button 
							onclick="window.location.href='MeusCartoes.html?id=<%=request.getAttribute("id")%>';">Cart�es</button>
						<button
							onclick="window.location.href='MeusEnderecos.html?id=<%=request.getAttribute("id")%>';">Endere�os</button>
						<button
					...
					<button class="button-dados-perfil">
						<img src="../imagens/assets/icons-left-perfil-3.png" alt=""
							class="img-icons-perfil"> <span
							onclick="window.location.href='Notifica��es.jsp';">Notificacoes</span>
					</button>
            ...
            <div class="container-register">
                ...
                <div class="box-top-register">
                    <!-- titulo do cabecalho -->
                    <h1 class="text-perfil">Notifica��es</h1>
                ...
                <div class="content-notification">
    				...
    				<div class="card mt-3" style="background-color: #F0F0F0; width: 50rem;">
				        <div class="card-body">
				            ...
				            <p class="card-text">Mensagem da notifica��o 1.</p>
				            <p class="card-text">Data da notifica��o: 10/03/2024</p>
				        </div>
				    </div>
    				...
    				<div class="card mt-3" style="background-color: #F0F0F0; width: 50rem;">
				        <div class="card-body">
				            ...
				            <p class="card-text">Mensagem da notifica��o 2.</p>
				            <p class="card-text">Data da notifica��o: 11/03/2024</p>
				        </div>
				    </div>
    				...
    				<div class="card mt-3" style="background-color: #F0F0F0; width: 50rem;">
				        <div class="card-body">
				            ...
				            <p class="card-text">Mensagem da notifica��o 3.</p>
				            <p class="card-text">Data da notifica��o: 12/03/2024</p>
				        </div>
				    </div>
                    <!-- acaba aqui -->
